    ...
    <div className="container bg-light rounded-5 pe-5">
        <div className="row">
            ...
            <div className="mt-2 pb-3 d-flex justify-content-center">
                <button type="button" className="btn btn-dark btn-lg w-50">Sing In</button>
            </div>

            <div className="pb-4">
                <div className="d-flex justify-content-center text-white col-12 mb-2 fs-5">
                    <input className="form-check-input" type="checkbox" value="" id="checkDefault" />
                    <label className="form-check-label ps-3 text-black" htmlFor="checkDefault">Acepto términos, condiciones y
                        políticas de privacidad</label>
                </div>
                <div className="d-flex justify-content-center text-white ms-4 col-10 mb-4 fs-5">
                    <input className="form-check-input" type="checkbox" value="" id="checkDefault" />
                    <label className="form-check-label ps-3 text-black" htmlFor="checkDefault">Deseo recibir promociones y ofertas</label>
                </div>
            </div>
        </div>
