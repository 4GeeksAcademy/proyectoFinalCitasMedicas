...
const Dark = ({ children }) => <span classNameName="bg-dark text-white px-1 rounded">{children}</span>;
export const BackendURL = () => (
	<div classNameName="mt-5 pt-5 w-50 mx-auto">
		...
		<div classNameName="w-100">
			<img src={envFile} classNameName="w-100" />
		</div>
